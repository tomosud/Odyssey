---
title: "BOOK II(第2歌)原文"
book: 2
roman: II
heading_en: "ASSEMBLY OF THE PEOPLE OF ITHACA—SPEECHES OF TELEMACHUS AND OF THE SUITORS—TELEMACHUS MAKES HIS PREPARATIONS AND STARTS FOR PYLOS WITH MINERVA DISGUISED AS MENTOR."
...
> [!abstract] 梗概(和訳)
> イタケ市民の集会 — テレマコスと求婚者たちの応酬 — テレマコス、メントルに変身したアテナと共にピュロスへ出発

和訳 → [[02_第2歌_和訳]] / 脚注 17–23 → [[99_脚注(Footnotes)]](本文中では語末に付いた素の数字が脚注番号)
