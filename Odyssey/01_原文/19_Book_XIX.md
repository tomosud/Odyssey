---
title: "BOOK XIX(第19歌)原文"
book: 19
roman: XIX
heading_en: "TELEMACHUS AND ULYSSES REMOVE THE ARMOUR—ULYSSES INTERVIEWS PENELOPE—EURYCLEA WASHES HIS FEET AND RECOGNISES THE SCAR ON HIS LEG—PENELOPE TELLS HER DREAM TO ULYSSES."
...
> [!abstract] 梗概(和訳)
> テレマコスとオデュッセウス、武具を隠す — オデュッセウス、ペネロペと語り合う — 乳母エウリュクレイア、足を洗って脛の傷跡に気づく — ペネロペ、夢を語る

和訳 → [[19_第19歌_和訳]] / 脚注 152–155 → [[99_脚注(Footnotes)]](本文中では語末に付いた素の数字が脚注番号)
