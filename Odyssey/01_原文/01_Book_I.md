...
book: 1
roman: I
heading_en: "THE GODS IN COUNCIL—MINERVA’S VISIT TO ITHACA—THE CHALLENGE FROM TELEMACHUS TO THE SUITORS."
...
> [!abstract] 梗概(和訳)
> 神々の評議 — アテナ、イタケを訪れる — テレマコス、求婚者たちに挑む

和訳 → [[01_第1歌_和訳]] / 脚注 1–16 → [[99_脚注(Footnotes)]](本文中では語末に付いた素の数字が脚注番号)
