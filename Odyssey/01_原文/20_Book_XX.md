---
title: "BOOK XX(第20歌)原文"
book: 20
roman: XX
heading_en: "ULYSSES CANNOT SLEEP—PENELOPE’S PRAYER TO DIANA—THE TWO SIGNS FROM HEAVEN—EUMAEUS AND PHILOETIUS ARRIVE—THE SUITORS DINE—CTESIPPUS THROWS AN OX’S FOOT AT ULYSSES—THEOCLYMENUS FORETELLS DISASTER AND LEAVES THE HOUSE."
...
> [!abstract] 梗概(和訳)
> 眠れぬオデュッセウス — ペネロペ、アルテミスに祈る — 天からの二つの予兆 — エウマイオスとピロイティオスの到着 — 求婚者たちの宴 — クテシッポス、牛の足を投げつける — テオクリュメノス、破滅を予言して館を去る

和訳 → [[20_第20歌_和訳]] / 脚注 156–160 → [[99_脚注(Footnotes)]](本文中では語末に付いた素の数字が脚注番号)
