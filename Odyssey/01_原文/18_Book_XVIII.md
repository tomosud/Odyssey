---
title: "BOOK XVIII(第18歌)原文"
book: 18
roman: XVIII
heading_en: "THE FIGHT WITH IRUS—ULYSSES WARNS AMPHINOMUS—PENELOPE GETS PRESENTS FROM THE SUITORS—THE BRAZIERS—ULYSSES REBUKES EURYMACHUS."
...
> [!abstract] 梗概(和訳)
> イロスとの殴り合い — オデュッセウス、アムピノモスに警告する — ペネロペ、求婚者たちから贈り物を受け取る — 火鉢の番 — オデュッセウス、エウリュマコスをたしなめる

和訳 → [[18_第18歌_和訳]] / 脚注 148–151 → [[99_脚注(Footnotes)]](本文中では語末に付いた素の数字が脚注番号)
